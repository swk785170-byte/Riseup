...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed right-5 bottom-5 z-[95] flex h-14 w-14 items-center justify-center rounded-full bg-foreground text-background shadow-[0_14px_34px_-10px_rgba(11,11,11,0.55)] md:right-8 md:bottom-8"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
